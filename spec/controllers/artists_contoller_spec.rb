...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested artist as @artist and renders the artist show template " do
      artist = create(:artist)
  ...
  describe "GET #new" do
    it "assigns a new artist as @artist and renders the artist new template" do
      create(:artist)
  ...
  describe "GET #edit" do
    it "assigns found artist as @artist and renders the artist edit template" do
      artist = create(:artist)
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created artist as @artist" do
        ...
        expect(response).to have_http_status(302) #why status code 302 and not 201?
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      it "assigns found artist as @artist" do
        artist = create(:artist)
